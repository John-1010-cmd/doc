...
tags: 
  - JVM
  - 调优
description: JVM、数据库、多线程三大维度性能调优实战，从原理到工具的全面总结。
series: JVM 原理与调优
series_order: 2
---
...
![image-20230501202018636](image-20230501202018636.png)

**异步执行（开启额外线程来执行）**

![image-20230501202033022](image-20230501202033022.png)
...
![image-20230501230950842](image-20230501230950842.png)

2. 关键性能指标

![image-20230501231115699](image-20230501231115699.png)

吞吐量百分比越高表明GC开销越低。

3. GC可视化交互聚合结果

![image-20230501231329656](image-20230501231329656.png)

存在问题：一开始就发生了 3 次full gc , 很明显不太正常；

4. GC统计

![image-20230501231408233](image-20230501231408233.png)

5. GC原因

![image-20230501231440234](image-20230501231440234.png)
...
![image-20230501231828097](image-20230501231828097.png)

![image-20230501231840235](image-20230501231840235.png)

![image-20230501231856458](image-20230501231856458.png)
...
![image-20230501233359509](image-20230501233359509.png)

![image-20230501233431388](image-20230501233431388.png)

![image-20230501233441369](image-20230501233441369.png)
...
![image-20230502000404566](image-20230502000404566.png)

![image-20230502000413917](image-20230502000413917.png)
