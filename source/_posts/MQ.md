...
tags: 
  - MQ
  - 实战
description: 消息队列技术选型与原理详解，对比 RabbitMQ、Kafka、RocketMQ、ActiveMQ 的优劣与适用场景。
series: 消息队列与异步通信
series_order: 1
---
...
![image](image.lggsifrqz8w-16823290511882.webp)
...
![image](image.3mng0kiqphi0.webp)

![image](image.7418cd7x0u80.webp)
...
![image](image.5ldx5kffws00.webp)

![image](image.4k5fjvtukpe0.webp)

![image](image.5g2svti1sec0.webp)
...
![image-20230425105657972](image-20230425105657972.png)

![image-20230425105801287](image-20230425105801287.png)
...
![image-20230425105935361](image-20230425105935361.png)
...
![image-20230425110043092](image-20230425110043092.png)

如果consumer2崩溃了，此时需要进行rebalance。如果是Range分配和轮询分配都会重新进行分配，例如：

![image-20230425110148890](image-20230425110148890.png)

consumer0和consumer1原来消费的分区大多发生了改变。看下粘性分配策略。

![image-20230425110243739](image-20230425110243739.png)
...
![image-20230425110540608](image-20230425110540608.png)

当生产者的ACK配置为0时，不等待broker确认，直接发送下一条数据，性能最高，但可能会存在数据丢失的情况。

**acks=1**

![image-20230425110713611](image-20230425110713611.png)

当生产者的ACK配置为1时，生产者会等待leader副本确认接收后，才会发送下一条数据，性能中等。

![image-20230425110732261](image-20230425110732261.png)
...
![image-20230425111819019](image-20230425111819019.png)
...
![image-20230425125445285](image-20230425125445285.png)
...
![image-20230425153225100](image-20230425153225100.png)
...
![image-20230425153617509](image-20230425153617509.png)

![image-20230425153757389](image-20230425153757389.png)
...
![image-20230425161750968](image-20230425161750968.png)
